...
class TrackObject():
    ...
    def process_video(self):
        ...
        while True:
            ...
            results = self.model(frame,classes=[1], device='mps')
            ...
            #     label = f"{tracker_id} {self.CLASS_NAMES_DICT[class_id]} {confidence:0.2f}"
            #     print(class_id)
            #     if class_id == 1:
            #         self.line_counter.update(detections=detections)
            #     if class_id == 0:
            #         self.line_counter.update2(detections=detections)
