...
from jiwen.algo.triangle_judgement import check_flip
from ultralytics import YOLO

from jiwen.algo.line_counter import LineCounter,LineCounterAnnotator
from jiwen.algo.utlib import find_corresponding_tracker_ids, calculate_center_points, \
    find_corresponding_tracker_ids2, find_most_common_value_lists
...
class TrackObject:
    ...
    def process_video(self, partnumber):
        ...
        while True:
            ...
            if self.model_path.endswith("hole.pt") and len(corresponding_tracker_ids) > 0:
            ...
            # print(f'corresponding_tracker_ids_all:{corresponding_tracker_ids_all}')
            ...
            if len(part_out_tracker_id) == 1 and part_out_tracker_id[0] in tracker_part_id_diff:
                ...
                # 如果是平板件，需要加上翻转信息
                if self.model_path.endswith("hole.pt") and part_out_tracker_id[0] in flip_result_dict:
            ...
            if len(part_out_tracker_id) > 1:
                ...
                for id in part_out_tracker_id:
                    ...
                    # update正反情况
                    if self.model_path.endswith("hole.pt") and id in flip_result_dict:
