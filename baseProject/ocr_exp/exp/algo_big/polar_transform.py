...
def main(imgpath):
    ...
    # 保存结果
    cv2.imwrite('/Users/hanbinliu/Desktop/test_rectangle_big.png', output)



if __name__ == '__main__':
    # 输入图像路径
    imgpath = '/Users/hanbinliu/Desktop/test_result_big.png'
    main(imgpath)
