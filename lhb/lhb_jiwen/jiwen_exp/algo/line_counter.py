...
class LineCounterAnnotator:
    ...
    def annotate(self, frame: np.ndarray, line_counter: LineCounter) -> np.ndarray:
        ...
        # 下面自己加的
        in_text2 = f"in: {line_counter.in_count2}"
        out_text2 = f"out: {line_counter.out_count2}"

        # (in_text_width2, in_text_height2), _ = cv2.getTextSize(
        #     in_text2, cv2.FONT_HERSHEY_SIMPLEX, self.text_scale, self.text_thickness
        # )
        ...
        # )
        # in_text_y2 = int(
        #     (line_counter.vector.end.y + line_counter.vector.start.y + in_text_height2)
        #     / 2
        #     - self.text_offset * in_text_height2+100
        # )
        ...
        out_text_y2 = int(
            ...
            / 2
            + self.text_offset * out_text_height2 + 100
        )

        # in_text_background_rect = Rect(
        #     x=in_text_x2,
        #     y=in_text_y2 - in_text_height2,
        #     width=in_text_width2,
        #     height=in_text_height2,
        # ).pad(padding=self.text_padding)
